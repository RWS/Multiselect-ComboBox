...
namespace Sdl.MultiSelectComboBox.Example.Models
{
    public class LanguageItems : INotifyPropertyChanged
    {
        ...
        public LanguageItems()
        {
            ...
            DetachAutoCompleteFilterBox = true;
        ...
        {
            get => _detachAutoCompleteFilterBox;
            set
            {
                if (_detachAutoCompleteFilterBox.Equals(value))
                {
                    return;
                }

                _detachAutoCompleteFilterBox = value;

                UpdateEventLog(nameof(DetachAutoCompleteFilterBox), _detachAutoCompleteFilterBox.ToString());

                OnPropertyChanged(nameof(DetachAutoCompleteFilterBox));
            }
        }
